...
if __name__ == "__main__":
    ...
    # Dynamically pick the map based on number
    map_files = {
        2: "M3_prac_map_full.txt",
        3: "M3_prac_map_part.txt",
        4: "M3_prac_map_min.txt"
    }

    selected_map = map_files.get(args.level_number)
    if selected_map is None:
        raise ValueError(f"No map defined for number {args.map_number}. Available options: {list(map_files.keys())}")
    ...
    fruits_list, fruits_true_pos, aruco_true_pos = read_true_map(selected_map)
