...
def estimate_pose(camera_matrix, obj_info, robot_pose):
    ...
    target_dimensions_dict = {'orange': [0.074,0.074,0.074], 'lemon': [0.053,0.072,0.046], 
                              'pear': [0.075,0.075,0.105], 'tomato': [0.068,0.068,0.059], 
                              'capsicum': [0.074,0.074,0.090], 'potato': [0.091,0.069,0.053], 
                              'pumpkin': [0.083,0.083,0.071], 'garlic': [0.065,0.065,0.072]}
    #########
