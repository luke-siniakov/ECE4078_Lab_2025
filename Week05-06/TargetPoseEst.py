...
def estimate_pose(camera_matrix, obj_info, robot_pose):
    ...
    target_dimensions_dict = {'orange': [0.075,0.077,0.073], 'lemon': [0.050,0.069,0.047], 
                              'pear': [0.077,0.077,0.1065], 'tomato': [0.070,0.070,0.064], 
                              'capsicum': [0.0723,0.0757,0.0897], 'potato': [0.094,0.067,0.055], 
                              'pumpkin': [0.080,0.079,0.073], 'garlic': [0.058,0.064,0.075]}
